...
const Header = () => {
  ...
  // --- Google Translate Setup (from Code A) ---
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16">
          <Link to="/" className="flex items-center space-x-2 flex-shrink-0 ml-0">
            ...
            <span className="text-xl font-poppins font-bold text-tecdia-gray-900">Tecdia</span>
          </Link>
          ...
          <div className="flex items-center space-x-4 flex-shrink-0 ml-auto mr-0 pl-8">
            ...
            {/* Google Translate (reduced language list) */}
            <div
